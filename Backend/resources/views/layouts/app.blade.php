...
<head>
    ...
    <title>@yield('title', 'St. Augustine Academy | Excellence in Education')</title>
...
<body class="@yield('body_class')">
    ...
    <header class="navbar">
        <div class="container nav-container">
            ...
            <nav class="nav-links" id="nav-links">
                ...
                <a href="{{ url('/student-life') }}">Student Life</a>
                <a href="{{ url('/news') }}">News & Events</a>
                <a href="{{ url('/contact') }}">Contact Us</a>
            </nav>
            <div class="nav-actions">
                <a href="{{ url('/admissions#apply') }}" class="btn btn-primary">Apply Now</a>
            </div>
        </div>
    </header>
    ...
    <footer class="footer">
        ...
        <div class="footer-bottom">
            <p>&copy; {{ date('Y') }} St. Augustine Academy. All rights reserved.</p>
        </div>
    </footer>
