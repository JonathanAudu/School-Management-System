...
@section('title', 'Home | St. Augustine Academy')
...
@section('content')
    ...
    <section class="hero" style="background-image: linear-gradient(rgba(15, 23, 42, 0.7), rgba(15, 23, 42, 0.4)), url('/images/hero.png');">
        <div class="container hero-content">
            ...
            <div class="hero-cta">
                <a href="{{ url('/academics') }}" class="btn btn-primary btn-lg">Explore Programs</a>
                <a href="{{ url('/gallery') }}" class="btn btn-outline btn-lg">Virtual Tour</a>
            </div>
        </div>
    </section>
    ...
    <section class="about-summary section-padding">
        <div class="container about-grid">
            <div class="about-text">
                ...
                <a href="{{ url('/about') }}" class="btn btn-outline mt-3" style="color: var(--secondary); border-color: var(--secondary);">Read Our Story</a>
            </div>
    ...
    <section class="latest-news section-padding bg-light">
        <div class="container">
            <div class="section-header d-flex justify-content-between align-items-end mb-5">
                ...
                <a href="{{ url('/news') }}" class="btn btn-outline" style="color: var(--secondary); border-color: var(--secondary);">View All News</a>
            </div>
    ...
    <section class="upcoming-events section-padding">
        <div class="container">
            ...
            <div class="text-center mt-4">
                <a href="{{ url('/news') }}" class="btn btn-primary">View Full Calendar</a>
            </div>
        </div>
    </section>
